...
def seed_users():
	...
	preference1 = random.randint(1,5),
	preference2 = random.randint(1,5),
	preference3 = random.randint(1,5),
	preference4 = random.randint(1,5),
	preference5 = random.randint(1,5),
	preference6 = random.randint(1,5),
	preference7 = random.randint(1,5),
	preference8 = random.randint(1,5),
	preference9 = random.randint(1,5),
	preference10 = random.randint(1,5),
